...
public class CameraRig : MonoBehaviour {
    ...
    public enum LocCheck {
		Outdoor,Indoor
	}
	public LocCheck locCheck;

	[System.Serializable]
	public class CameraSettings {
        [Header("-Positioning-")]
		public Vector3 indoorCamPos; //indoor
		public Vector3 outdoorCamPos; //outdoor
	...
	void CheckWall() {
        ...
        float dist = Mathf.Abs(locCheck == LocCheck.Indoor ? cameraSettings.indoorCamPos.z : cameraSettings.outdoorCamPos.z);
        ...
        if (Physics.SphereCast(start, cameraSettings.maxCheckDist, dir, out hit, dist ,wallLayers)) {
			...
			switch(locCheck) {
				case LocCheck.Indoor:
				PositionCamera(cameraSettings.indoorCamPos);
				    break;
				case LocCheck.Outdoor:
				PositionCamera(cameraSettings.outdoorCamPos);
				    break;
			}
		}
	}// [ CheckWall function End ]
	...
	public void PositionCamera(Vector3 cameraPos) {
		if(!mainCamera)
		return;
    ...
    }// [ CheckMeshRenderer function End ]
    ...
    public void SwitchCam() {
		switch(locCheck) {
			...
			case LocCheck.Outdoor:
			    locCheck = LocCheck.Indoor;
			    break;
		}
    }// [ SwitchCam function End ]
}// [ Class CameraRig End ]
